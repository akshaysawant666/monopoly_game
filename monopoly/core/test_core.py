...
# another player go to the construction land
def test8():
    print("---test8----")
    game = Game(2)
    steps, move_result = game.roll(3)
...
def test14(number):
    ...
    print(move_result)
    game.make_decision(move_result)
    print('the construction land property is: ', game.get_status()[1].get_land(8).get_content().get_property_num())
    print('the construction land property, can upgrade?: ',
          game.get_status()[1].get_land(8).get_content().is_constructable())
