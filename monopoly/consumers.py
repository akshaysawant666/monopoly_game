...
# @login_required
from .ws_handlers.game_change_handler import ChangeHandler
from .ws_handlers.game_handler import ws_connect_for_game, handle_roll, handle_confirm_decision, handle_cancel_decision, \
    handle_chat, handle_end_game
